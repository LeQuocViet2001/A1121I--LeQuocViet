...
<body >
<h1 style="margin-top: 30px; font-family: 'Baskerville Old Face'; text-align: center; font-size: 50px">Create Contract</h1>
<form method="post" action="/contract?action=add" style="margin-left: 150px; margin-right: 150px">
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="contract_start_date"  type="date" class="form-control"   placeholder="dd-mm-yyyy"  min="1997-01-01" max="2030-12-31" required>
        </div>

        <div class="col-md-6 mb-4">
            <label >contract_end_date</label>
            <input name="contract_end_date"  type="date" class="form-control"   placeholder="dd-mm-yyyy"  min="1997-01-01" max="2030-12-31" required>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="contract_deposit" type="number" class="form-control" value="" required placeholder="contract_deposit">
        </div>

        <div class="col-md-6 mb-4">
            <label >contract_total_money</label>
            <input name="contract_total_money" type="number" class="form-control" value="" required placeholder="contract_total_money">
        </div>
