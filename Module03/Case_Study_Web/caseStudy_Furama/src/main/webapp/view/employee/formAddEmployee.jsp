...
<form method="post" action="/employee?action=add" style="margin-left: 150px; margin-right: 150px">
    <div class="mb-4">
        ...
        <input name="employee_name" type="text" class="form-control" id="validationDefault01" value="" required placeholder="Enter your name...">
    </div>
    <div class="form-row">

        <div class="col-md-6 mb-4">
            <label >Salary</label>
            <input name="employee_salary" id="employee_salary" type="number"  class="form-control" placeholder="employee_salary"    required>
        </div>

        <div class="col-md-6 mb-4">
            <label >Birthday</label>
            <input name="employee_birthday" id="employee_birthday" type="date" class="form-control"   placeholder="dd-mm-yyyy"  min="1997-01-01" max="2030-12-31" required>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-4 mb-4">
            ...
            <input name="employee_id_card" type="text" class="form-control" id="validationDefault04" value="" required placeholder="Enter your ID card...">
        </div>
        <div class="col-md-4 mb-4">
            <label for="validationDefault01">Phone Number</label>
            <input name="employee_phone" type="text" class="form-control" id="validationDefault06" value="" required placeholder="Enter your phone number...">
        </div>
        <div class="col-md-4 mb-4">
            <label for="validationDefault01">Email address</label>
            <input name="employee_email" type="text" class="form-control" id="validationDefault07" value="" required placeholder="Enter your email...">
        </div>
    </div>
    <div class="form-row">
        <div class="col-md-6 mb-4">
            <label for="validationDefault01">Address</label>
            <input name="employee_address" type="text" class="form-control" id="validationDefault08" value=""  required placeholder="Enter your address...">
        </div>
        <div class="col-md-6 mb-4">
    ...
    <div class="form-row">
        <div class="col-md-4 mb-4">
            ...
            <input name="username" type="text" class="form-control" id="username" value="" required placeholder="Enter your username...">
        </div>
        <div class="col-md-4 mb-4">
        ...
        <div class="col-md-4 mb-4">
            ...
            <input name="password" type="text" class="form-control" id="Password" value="" required placeholder="Enter your password...">
        </div>
    </div>
