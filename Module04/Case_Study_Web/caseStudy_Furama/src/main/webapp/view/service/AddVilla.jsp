...
<form method="post" action="/service?action=add" style="margin-left: 150px; margin-right: 150px">
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="service_area" id="employee_salary" type="number" class="form-control"
                   placeholder="service_area" required>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="service_max_people" type="number" class="form-control" value="" required
                   placeholder="service_max_people">
        </div>
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="standard_room" type="number" class="form-control" value="" required
                   placeholder="standard_room">
        </div>
        <div class="col-md-6 mb-4">
            <label>number_of_floors</label>
            <input name="number_of_floors" type="number" class="form-control" value="" required
    ...
    <div class="form-row">
        ...
        <div class="col-md-6 mb-4">
            ...
            <input name="description_other_convenience" type="text" class="form-control" value="" required
                   placeholder="description_other_convenience">
        </div>
    </div>
