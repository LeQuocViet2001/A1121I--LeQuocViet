...
<form method="post" action="/service?action=add" style="margin-left: 150px; margin-right: 150px">
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="service_max_people" type="number" class="form-control" value="0" required
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            ...
            <input name="standard_room" type="number" class="form-control" value="0" required
                   placeholder="standard_room">
        </div>
        <div class="col-md-6 mb-4">
            <label>number_of_floors</label>
            <input name="number_of_floors" type="number" class="form-control" value="0" required
    ...
    <div class="form-row" hidden>
        ...
        <div class="col-md-6 mb-4">
            ...
            <input name="description_other_convenience" type="text" class="form-control" value=""
