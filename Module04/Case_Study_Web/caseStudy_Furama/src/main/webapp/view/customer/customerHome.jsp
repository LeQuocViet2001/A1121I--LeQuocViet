                    ...
                    <c:if test="${customers != null}">
                        <c:forEach items="${customers}" var="cus" varStatus="i">
                            <tr>
                                ...
                                <c:if test="${ cus.isCustomer_gender()  == true}">
                                    <td> male</td>
                                </c:if>
                                <c:if test="${ cus.isCustomer_gender() == false  }">
                                    <td> female</td>
                                </c:if>
                                ...
                                <td>
                                    <c:if test="${sessionScope.user == null}">
                                        <button type="button" id="btnEdit" class="btn btn-outline-info"
                                                data-toggle="modal" data-target="#modelFail">
                                            Edit
                                        </button>
                                    </c:if>

                                    <c:if test="${sessionScope.user != null}">
                                        <a href="/customer?action=edit&id=${ cus.getCustomer_id()}">
                                ...
                                <td>
                                    <button type="button" id="btnDel"
                                            onclick=" showModelDelete('${ cus.getCustomer_id() }','${cus.getCustomer_name()}'); "
