...
<form method="post" action="/customer?action=add" style="margin-left: 150px; margin-right: 150px">
    <div class="mb-4">
        ...
        <input name="customer_name" type="text" class="form-control" id="validationDefault01" value="" required
    ...
    <div class="form-row">
        ...
        <div class="col-md-6 mb-4">
            ...
            <input name="customer_birthday" type="date" class="form-control" placeholder="dd-mm-yyyy" min="1997-01-01"
    ...
    <div class="form-row">
        <div class="col-md-4 mb-4">
            <label>ID Card</label>
            <input name="customer_id_card" type="text" class="form-control" ivalue="" required
                   placeholder="Enter your ID card...">
        </div>
        <div class="col-md-4 mb-4">
            <label>Phone Number</label>
            <input name="customer_phone" type="text" class="form-control" value="" required
                   placeholder="Enter your phone number...">
        </div>
        <div class="col-md-4 mb-4">
            <label>Email address</label>
            <input name="customer_email" type="text" class="form-control" value="" required
    ...
    <div class="form-row">
        <div class="col-md-6 mb-4">
            <label>Address</label>
            <input name="customer_address" type="text" class="form-control" value="" required
